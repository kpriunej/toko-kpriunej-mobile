  ...
  return (
    <SafeAreaView edges={['bottom']}>
      <View className="bg-lime-100">
        <View className="flex-row justify-around items-center h-16 pt-1 bg-lime-100 shadow-sm shadow-slate-200">
            ...
            >
              <View className="relative">
                <Animated.View style={{ transform: [{ scale: scales[index] }] }}>
                  <FontAwesome5 name={iconName} size={20} color={focused ? '#047857' : '#6b7280'} solid={focused} />
                </Animated.View>
